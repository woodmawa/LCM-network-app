...
<html>
    ...
    <body>
        ...
        <div id="show-equipment" class="content scaffold-show" role="main">
            ...
            <f:display bean="equipment" />
            <g:form resource="${this.equipment}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.equipment}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
